...
public class SoundActivity extends BaseMVVMActivity<ModelViewModel, ActivitySoundBinding> implements View.OnClickListener {
    ...
    protected void onEvent() {
        ...
        bindingView.voiceaddTv.setOnClickListener(this);
        bindingView.voicelessTv.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.swich_iv:
                ...
                break;
            case R.id.voiceadd_tv:
                updateIrCode(getKeyId("音量+"));
                break;
            case R.id.voiceless_tv:
